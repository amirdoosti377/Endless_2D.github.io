...
export function snapshot(w){return {version:1,world:Object.fromEntries(fields.map(k=>[k,w[k]]))};}
...
export class RunSave{
 ...
 restore(world,data){for(const k of fields)world[k]=structuredClone(data[k]);world.events=[];}
}
